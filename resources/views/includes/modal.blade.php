      ...
      <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
        ...
        <div class="modal-body relative p-4">
            <div class="mb-8">
                ...
                <div class="mb-4 flex space-x-3">
                    <div class="w-full">
                        <input class="focus:ring-2 focus:ring-blue-500 focus:outline-none appearance-none w-full text-sm leading-6 text-slate-900 placeholder-slate-400 rounded-md pl-5 py-2 ring-1 ring-slate-200 shadow-sm" type="text" aria-label="EID" placeholder="Email ID *" name="email">
                    </div>
                    <div class="w-full">
                        <input class="focus:ring-2 focus:ring-blue-500 focus:outline-none appearance-none w-full text-sm leading-6 text-slate-900 placeholder-slate-400 rounded-md pl-5 py-2 ring-1 ring-slate-200 shadow-sm" type="text" aria-label="MNO" placeholder="Mobile No *" name="mobile">
                    </div>
                    <div class="w-full">
                        @php
                ...
                <div class="flex space-x-3">
                    ...
                    <div class="w-full">
                        <input class="focus:ring-2 focus:ring-blue-500 focus:outline-none appearance-none w-full text-sm leading-6 text-slate-900 placeholder-slate-400 rounded-md pl-5 py-2 ring-1 ring-slate-200 shadow-sm" type="text" aria-label="PASS" placeholder="Password *"name="password">
                    </div>
                    <div class="w-full">
                        <input class="focus:ring-2 focus:ring-blue-500 focus:outline-none appearance-none w-full text-sm leading-6 text-slate-900 placeholder-slate-400 rounded-md pl-5 py-2 ring-1 ring-slate-200 shadow-sm" type="text" aria-label="CP" placeholder="Confirm Password *"name="password_confirmation">
                    </div>
                </div>
            </div>
            <div>
